...
;; color scheme
(define base00 #(36 39 40))
(define base01 #(48 56 59))
(define base02 #(60 71 76))
(define base03 #(82 96 104))
(define base04 #(118 137 147))
(define base05 #(174 186 191))
(define base06 #(232 232 232))
(define base07 #(246 248 248))
(define base08 #(232 115 100))
(define base09 #(241 167 79))
(define base0A #(248 208 160))
(define base0B #(147 212 172))
(define base0C #(129 181 188))
(define base0D #(67 169 207))
(define base0E #(149 129 173))
(define base0F #(200 180 140))

(define framework:color-schemes
  `(#hash((name . "Base16 Simple Dark")
