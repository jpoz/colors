;; Base16 Simple (https://github.com/chriskempson/base16)
;; Scheme: JPOZ (http://jpoz.net)

;;; base16-simple-light-theme.el

;;; Code:

(deftheme base16-simple-light)
...
(provide-theme 'base16-simple-light)

;;; base16-simple-light-theme.el ends here
