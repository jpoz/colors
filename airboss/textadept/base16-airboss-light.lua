-- Airboss theme for Textadept (http://foicica.com/textadept/)
-- Theme author: JPOZ (http://jpoz.net)
...
property['color.base00'] = 0x2E2D2B
property['color.base01'] = 0x3D3C39
property['color.base02'] = 0x5C5A56
property['color.base03'] = 0x8D8982
property['color.base04'] = 0x959595
property['color.base05'] = 0x99A29C
property['color.base06'] = 0xCCD0CD
property['color.base07'] = 0xF0F0F0
property['color.base08'] = 0x5F5AFF
property['color.base09'] = 0x91AAFF
property['color.base0A'] = 0x00B4FF
property['color.base0B'] = 0x71E08C
property['color.base0C'] = 0xC1D100
property['color.base0D'] = 0x877A00
property['color.base0E'] = 0x51007B
property['color.base0F'] = 0x6CA7B4
