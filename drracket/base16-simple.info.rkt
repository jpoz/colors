...
(define base08 #(237 115 95))
(define base09 #(245 169 64))
(define base0A #(250 209 155))
(define base0B #(141 213 170))
(define base0C #(52 167 210))
(define base0D #(150 127 175))
(define base0E #(232 141 192))
(define base0F #(201 181 136))
